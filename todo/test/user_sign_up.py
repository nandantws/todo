...
class UserSignUpTestCase(APITestCase):
    ...
    def setUpClass(cls):
        ...
        cls.last_name = 'jain'
        cls.user = User.objects.create(username = 'aj',password='test_Pass',email='anne@user.com',first_name = 'anne',last_name = 'jaey')
    ...
    def test_if_data_is_correct_then_signup(self):
        ...
        self.assertEqual(str(response.data['message']),'User Created Successfully.')
